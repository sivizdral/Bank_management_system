...
@NamedQueries({
    ...
    @NamedQuery(name = "Transakcija.findByIdRacSa", query = "SELECT t FROM Transakcija t WHERE t.idRacSa = :idRacSa"),
    @NamedQuery(name = "Transakcija.findByIdRacKa", query = "SELECT t FROM Transakcija t WHERE t.idRacKa = :idRacKa"),
