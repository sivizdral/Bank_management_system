...
CREATE TABLE `transakcija` (
  ...
  PRIMARY KEY (`IdTra`),
  KEY `transakcija_racun_fk_sa_idx` (`IdRacSa`),
  KEY `transakcija_racun_fk_ka_idx` (`IdRacKa`),
  CONSTRAINT `transakcija_racun_fk_ka` FOREIGN KEY (`IdRacKa`) REFERENCES `racun` (`IdRac`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `transakcija_racun_fk_sa` FOREIGN KEY (`IdRacSa`) REFERENCES `racun` (`IdRac`) ON DELETE CASCADE ON UPDATE CASCADE
